...
@method_decorator([login_required, permission_required('smartdoc.add_product', raise_exception=True)], name='dispatch')
...
@method_decorator([login_required, permission_required('smartdoc.change_product', raise_exception=True)], name='dispatch')
...
def document_search(request):
    q = request.GET.get('q')
    if q:
        document_list = Document.objects.filter(Q(title__icontains=q) | Q(product__name__icontains=q) | Q(product__code__icontains=q))
